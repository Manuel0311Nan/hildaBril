...
<section>
    ...
    <article class="mt-5">
        <div class="row mx-auto">
            <div class="col-md-6 d-flex flex-column align-items-end">
                <a href="#" class="elemSeccion">
                    <div class="animate__animated animate__backInUp">
                        <img class="fotosHome" src="<?= URL . '/public/assets/images/reciclaje.jpg' ?>" alt="reciclaje">
                        <h2 class="nomSeccion text-center" style="font-size: 80px;">R))d))eciclaje de Vestidos</h2>
                    </div>
                </a>
                <a href="#" class="elemSeccion">
    ...
    <article class="row mt-2 tercerArticle">
        <div class="col-6 d-flex flex-column justify-content-center">
            <div class="mx-4">
                <h4 class="titleRrss" style="font-size: 50px;">Follow our Instagram for exclusive content <a href="#" class="btnInstagram w-25"> <span  style="font-size: 30px;">@HildaBril</span> </a></h4>
            </div>
            <div class="d-flex justify-content-around align-items-center">
                <h4 class="titleRrss" style="font-size: 50px;">Send us a message</h4>
                <a href="#" class="btnInstagram w-25 h2"> <span style="font-size: 30px;">Contact</span> </a>
            </div>
        </div>
        <div class="col-6">
