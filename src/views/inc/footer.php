...
<footer class=" tercerArticle">
    <div class=" d-flex flex-column flex-lg-row justify-content-center align-items-center">
        <div class="col-lg-4 ">
            <h4 class="apartadosFooter text-center" style="font-size: 50px;">Redes Sociales</h4>
        ...
        <div class="col-lg-4 ">
        <h4 class="apartadosFooter text-center" style="font-size: 50px;">Servicios</h4>
           <a href="#"> <h4 class="apartadosFooter text-center" style="font-size: 20px;">Vestidos de novia</h4></a>
        ...
        <div class="col-lg-4  d-flex flex-column align-items-center">
            ...
            <h4 class="apartadosFooter text-center" style="font-size: 50px;">Subscripción a Newsletter</h4>
            <input class="w-50" type="text" Placeholder="Introduce tu email..." pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
            <button class="btn buttonNewsletter">Subscríbeme a la newsletter</button>
        </div>
    </div>
    </footer>
